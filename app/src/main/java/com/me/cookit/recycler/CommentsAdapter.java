...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.MyViewHolder> {
    ...
    private List<com.me.cookit.recycler.ItemComment> items;
    ...
    public CommentsAdapter(List<com.me.cookit.recycler.ItemComment> items, Context context) {
        this.items = items;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        com.me.cookit.recycler.ItemComment itemComment = items.get(position);
